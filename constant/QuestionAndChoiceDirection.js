const Question = [];
Question[0] = "Q1"; //Question 1 
Question[1] = "Q2"; //Question 2
Question[2] = "Q3"; //Question 3
Question[3] = "Q4"; //Question 4

const Ans_up = [];
Ans_up[0] = "U-Q1";  //swipe up choice for question 1
...
const Ans_down = [];
Ans_down[0] = "D-Q1";  //swipe down choice for question 1
...
const Ans_left = [];
Ans_left[0] = "L-Q1";  //swipe left choice for question 1
...
const Ans_right = [];
Ans_right[0] = "R-Q1";  //swipe right choice for question 1  
